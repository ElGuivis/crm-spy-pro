...
import { Send, Play, Pause, Trash2, Eye, Clock, CheckCircle, XCircle, Loader2, Coins, Users, Pencil, RotateCw } from "lucide-react";
...
export function CampaignCard({ campaign, onStart, onPause, onView, onDelete, onEdit, onRetryFailed }: CampaignCardProps) {
