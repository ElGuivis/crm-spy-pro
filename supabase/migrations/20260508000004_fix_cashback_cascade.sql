-- Fix cashback cascade order:
-- cashback_executions.reminder_id → cashback_reminders
-- cashback_executions.config_id  → cashback_configs
-- cashback_executions.coupon_id  → generated_coupons
-- cashback_reminders.config_id   → cashback_configs
-- cashback_reminders.coupon_id   → generated_coupons
-- Must delete executions → reminders → configs/coupons
